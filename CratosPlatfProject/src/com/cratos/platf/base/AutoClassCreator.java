...
public class AutoClassCreator {
    ...
    private static final String jdbc_url = "jdbc:mysql://localhost:3306/platf_core?serverTimezone=GMT&userSSL=false";//数据库url
    ...
    public static void main(String[] args) throws Exception {
        ...
        String pkg = "com.cratos.platf.crowd";  //与base同级的包名

        final String entityClass = "CrowdApplyDayRecord";//类名
